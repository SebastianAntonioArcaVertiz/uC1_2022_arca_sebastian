...
SOURCEFILES_QUOTED_IF_SPACED=displayA0.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/displayA0.o
POSSIBLE_DEPFILES=${OBJECTDIR}/displayA0.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/displayA0.o

# Source Files
SOURCEFILES=displayA0.s
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/displayA0.o: displayA0.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/displayA0.o 
	${MP_AS} -mcpu=PIC18F57Q84 -c \
	-o ${OBJECTDIR}/displayA0.o \
	displayA0.s \
